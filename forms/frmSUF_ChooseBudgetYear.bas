...
Begin Form
    ...
    RecSrcDt = Begin
        0x4f11e14c1407e640
    End
    Caption ="SUF budgetsystem - support: ring Dan Johansen på tlf. 20 53 53 28"
        ...
        Begin FormHeader
            ...
            Begin
                Begin Label
                    ...
                    FontWeight =700
                    Name ="Auto_hoved0"
                    Caption ="Velkommen til \015\012SUF Budget System"
                ...
                Begin ComboBox
                    ...
                    RowSource ="SELECT [qryDistinctBudgetYears].[Year_] FROM qryDistinctBudgetYears ORDER BY [Ye"
                        "ar_]; "
                    ColumnWidths ="1440"
                    AfterUpdate ="[Event Procedure]"

                    LayoutCachedLeft =7879
                    LayoutCachedTop =734
                    ...
                    Begin
                        Begin Label
                            ...
                            Name ="Year__Label"
                            Caption ="Budgetår "
                            LayoutCachedLeft =7809
                            LayoutCachedTop =346
                            LayoutCachedWidth =9219
                            LayoutCachedHeight =661
                            ForeThemeColorIndex =1
                            ForeTint =100.0
                        End
                    End
                ...
                Begin ComboBox
                    ...
                    Name ="cboAfdelingUni"
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT tblAfdeling.[AfdNr Uniconta], tblAfdeling.AfdelingsNavn FROM tblAfdeling "
                        "WHERE (((tblAfdeling.[Year_])=2024)) ORDER BY tblAfdeling.[AfdNr Uniconta]; "
                    ColumnWidths ="0;2835"
                    AfterUpdate ="[Event Procedure]"
                ...
                Begin CommandButton
                    ...
                    TabIndex =2
                    Name ="btnPrintIB"
                    Caption ="Udskriv Internt budget"
                    OnClick ="[Event Procedure]"
                    ControlTipText ="Udskriv internt budget til Excel"
                    GroupTable =3
                    VerticalAnchor =1
        ...
        Begin Section
            ...
            Begin
                Begin Subform
                    ...
                    Height =15423
                    Name ="frmDashboard"
                    SourceObject ="Form.frmDashboard"

                    LayoutCachedLeft =56
                    LayoutCachedTop =56
                    LayoutCachedWidth =23006
                    LayoutCachedHeight =15479
                End
            End
        End
        Begin FormFooter
...
End
CodeBehindForm
' See "frmSUF_ChooseBudgetYear.cls"
